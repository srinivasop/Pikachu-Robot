...
import PikachuRobot.modules.sql.blsticker_sql as sql
from PikachuRobot import LOGGER, REDIS, dispatcher
...
def __stats__():
    return "{} number of blacklist stickers across {} chats".format(
