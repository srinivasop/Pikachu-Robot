...
import PikachuRobot.modules.sql.connection_sql as sql
from PikachuRobot import dispatcher, DRAGONS, DEV_USERS
from PikachuRobot.modules.helper_funcs import chat_status
